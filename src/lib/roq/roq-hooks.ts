...
export function useRecruitmentFindMany<
...
>(
  ...
  const roq = useRoqClient();
  const key = JSON.stringify(['useRecruitmentFindMany', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.recruitment.findMany(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useRecruitmentCount<T extends Prisma.recruitmentCountArgs, R extends number>(
  args?: Prisma.SelectSubset<T, Prisma.recruitmentCountArgs>,
  options?: RequestOptions,
  swrOptions?: SWRRequestOptions<R>,
) {
  const roq = useRoqClient();
  const key = JSON.stringify(['useRecruitmentCount', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.recruitment.count(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useRecruitmentFindManyWithCount<
  T extends Prisma.recruitmentFindManyArgs,
  R extends { data: GetFindResult<Prisma.$recruitmentPayload<DefaultArgs>, T>[]; count: number },
>(
  args?: Prisma.SelectSubset<T, Prisma.recruitmentFindManyArgs>,
  options?: RequestOptions,
  swrOptions?: SWRRequestOptions<R>,
  ...
  const roq = useRoqClient();
  const key = JSON.stringify(['useRecruitmentFindManyWithCount', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.recruitment.findManyWithCount(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useRecruitmentFindFirst<
...
>(
  ...
  const roq = useRoqClient();
  const key = JSON.stringify(['useRecruitmentFindFirst', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.recruitment.findFirst(args, options);
      return result as R;
    },
    {
      ...swrOptions,
