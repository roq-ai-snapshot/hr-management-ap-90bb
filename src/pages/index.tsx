  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Experience efficiency and productivity like never before with HR Management Application, your comprehensive solution for all HR-related tasks."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience efficiency and productivity like never before with HR Management Application, your comprehensive solution for all HR-related tasks.`}
            </Text>
            <Box
