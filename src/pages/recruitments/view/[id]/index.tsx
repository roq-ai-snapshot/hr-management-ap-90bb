...
import { useRecruitmentFindFirst, useRoqClient } from 'lib/roq';
...
function RecruitmentViewPage() {
  ...
  const { data, error, isLoading } = useRecruitmentFindFirst(queryParams, {}, { disabled: !id });
            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('recruitment', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/recruitments/edit/${id}`} passHref legacyBehavior>
                    <Button
              ...
              >
                ...
                <FormListItem label="Closed At" text={data?.closed_at ? format(data?.closed_at, 'dd-MM-yyyy') : ''} />
