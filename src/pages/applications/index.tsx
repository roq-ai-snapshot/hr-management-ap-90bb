...
export function ApplicationListPage(props: ApplicationListPageProps) {
  ...
  const columns: ColumnType[] = [
    ...
    },
    {
      ...
      cell: ({ row: { original: record } }: any) =>
        record?.interview_at ? format(record?.interview_at, 'dd-MM-yyyy') : '',
    },
    {
      id: 'offer_at',
      header: 'Offer At',
      accessorKey: 'offer_at',
      cell: ({ row: { original: record } }: any) => (record?.offer_at ? format(record?.offer_at, 'dd-MM-yyyy') : ''),
    },
      ...
      ? {
          ...
          cell: ({ row: { original: record } }: any) => (
            <Link
              ...
              href={`/recruitments/view/${record.recruitment?.id}`}
            >
